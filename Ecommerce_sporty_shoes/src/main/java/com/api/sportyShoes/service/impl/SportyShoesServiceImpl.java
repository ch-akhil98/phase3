...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	@PostConstruct
	public void init() {
		Shoe s1 = new Shoe(1,"Shoe 1","Basketball",1200.24);
		Shoe s2 = new Shoe(2,"Shoe 2","Cricket",1160.82);
		Shoe s3 = new Shoe(3,"Shoe 3","Running",935.20);
		Shoe s4 = new Shoe(4,"Shoe 4","Football",2100.74);
